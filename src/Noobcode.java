public class Noobcode {
    public static void main(String[] args) {
        ...
        // Побитовые операции
        // Присваивание - новый бит сохраняет значение замещенного бита
        ...
        System.out.println("^ - Побитовое исключающее ИЛИ (XOR)"); // тоже самое что ИЛИ, только 2 бита одинаковые, заменяет на 0
